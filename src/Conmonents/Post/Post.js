...
class Post extends Component {
  ...
  render () {
    ...
    const likeButton = !authenticated ? (
      <NavLink to='/login'>
        <div>
          <button className='btn btn-light liked'>
            <img src={unlike} width='25px' height='25px' alt='unlike' />{' '}
      ...
      <div>
        <button onClick={this.unlikePost} className='btn btn-light liked'>
          <img src={like} width='25px' height='25px' alt='unlike' />
        </button>
        <span>{this.props.likeCount} Likes</span>
      </div>
    ) : (
      <div>
        <button onClick={this.likePost} className='btn btn-light unlike'>
          <img src={unlike} width='25px' height='25px' alt='like' />
        </button>
        <span>{this.props.likeCount} Likes</span>
      </div>
    )
    ...
    const deletPost =
      ...
      userName === credentials.userName ? (
        <DeletePost postId={postId} key={this.props.postId} />
        ) : null
        ...
        <div className='card text-info card'>
          <div className='card-header text-left text-info'>
            <div className='row flex-nowrap'>
              ...
              <div className='col-md-1 test-grid col-sm-1'>{deletPost}</div>
            </div>
          </div>
